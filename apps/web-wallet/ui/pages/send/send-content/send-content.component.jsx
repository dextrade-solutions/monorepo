...
import GasMultisignDisplay from '../gas-multisign-display';
...
export default class SendContent extends Component {
  ...
  render() {
    ...
    const { sharedProvider } = sendAsset;
    return (
      <PageContainerContent>
        <div className="send-v2__form">
          ...
          <SendAmountRow />
          {networkOrAccountNotSupports1559 &&
          sharedProvider.isEthTypeNetwork ? (
            <SendGasRow />
          ) : null}
          ...
          {txData.asset.isMultisign ? (
            <GasMultisignDisplay gasError={gasError} />
          ) : null}
        </div>
      </PageContainerContent>
    );
