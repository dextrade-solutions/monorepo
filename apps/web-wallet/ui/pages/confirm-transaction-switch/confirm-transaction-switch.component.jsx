...
export default class ConfirmTransactionSwitch extends Component {
  ...
  render() {
    const { txData } = this.props;
    if (txData?.type === TransactionType.swap && txData.exchangerType === ExchangerType.P2PExchanger) {
      const pathname = `${CONFIRM_TRANSACTION_ROUTE}/${txData.id}${CONFIRM_APPROVE_P2P_PATH}`;
      return <Redirect to={{ pathname }} />;
    }
    if (txData.txParams) {
