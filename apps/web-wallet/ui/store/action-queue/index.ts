...
import metamaskConnection from '../../../app/scripts/background-pwa';
///: END:ONLY_INCLUDE_IN
...
export async function submitRequestToBackground<R>(
  ...
  ///: BEGIN:ONLY_INCLUDE_IN(pwa)
  const api = metamaskConnection.controller.getApi() as any;
 ...
 */
export const callBackgroundMethod = async <R>(
  method: string,
  args: any[],
