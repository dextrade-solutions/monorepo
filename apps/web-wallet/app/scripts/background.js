 ...
 * @property {ExchangerReserve[]} exchangerReserves - Returns true if the user has initiated the password recovery screen, is recovering from seed phrase.
 * @property {object} tokensRegistry - all tokens metadata
 * @property {import('./controllers/chains-controller/types').UsedNetworks} usedNetworks - all active networks
 * @property {{ [selectedAddress: string]: import('../overrided-metamask/assets-controllers').AssetBalance[] }} balances - all current token balance states
 */
