...
export default class AppStateController extends EventEmitter {
  ...
  constructor(opts = {}) {
    ...
    this.store = new ObservableStore({
      ...
      defaultSwapsActiveTabName: null,
      browserEnvironment: {},
      popupGasPollTokens: [],
  ...
  setLoading(state = true) {
    this.store.updateState({ isLoading: state });
  }
   ...
   * Sets the default home tab
   *
   * @param {string} [defaultSwapsActiveTabName] - the swaps tab name
   */
  setDefaultSwapsActiveTabName(defaultSwapsActiveTabName) {
    this.store.updateState({
