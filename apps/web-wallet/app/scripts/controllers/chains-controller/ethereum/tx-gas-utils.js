...
export default class TxGasUtil {
   ...
   * @param {object} query - the EthQuery instance
   * @returns {GasAnalysisResult} The result of the gas analysis
   */
  async analyzeGasUsage(txMeta, query) {
    ...
    let simulationFails;
    try {
      estimatedGasHex = await this.estimateTxGas(txMeta, query);
   ...
   */
  async estimateTxGas(txMeta, query) {
