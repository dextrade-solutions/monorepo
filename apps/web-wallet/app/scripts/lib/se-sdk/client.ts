...
export class SingleEthereum extends ISingleEthereum {
  ...
  public on: ISingleEthereum['on'] = (name, listener) => {
    return this.events.on(name, listener);
  };

  public once: ISingleEthereum['once'] = (name, listener) => {
    return this.events.once(name, listener);
  };

  public off: ISingleEthereum['off'] = (name, listener) => {
  ...
  public formatAuthMessage: ISingleEthereum['formatAuthMessage'] = (
    payload,
    address,
  ) => {
    try {
  ...
  public approveAuthRequest: ISingleEthereum['approveAuthRequest'] = (
    payload,
  ) => {
    try {
  ...
  public rejectAuthRequest: ISingleEthereum['rejectAuthRequest'] = (
    payload,
  ) => {
    try {
